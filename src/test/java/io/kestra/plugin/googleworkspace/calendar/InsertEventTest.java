...
class InsertEventTest {
    ...
    void run() throws Exception {
        ...
        CalendarTime startTime = CalendarTime.builder()
            .dateTime(Property.of("2024-11-28T09:00:00+05:30"))
            .timeZone(Property.of("Asia/Calcutta")).build();
        CalendarTime endTime = CalendarTime.builder()
            .dateTime(Property.of("2024-11-28T10:00:00+05:30"))
            .timeZone(Property.of("Asia/Calcutta")).build();

        InsertEvent task = InsertEvent.builder()
            .calendarId(Property.of("primary"))
            .summary(Property.of("New Calendar Event"))
